...
public class Quiz {
    ...
    public static int find(String name, String pass) {
        try {
            FileReader file3 = new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Credentials.txt");
            BufferedReader bf3 = new BufferedReader(file3);
            String s6 = " ", s7 = " ";
            while (s7 != null) {
                s6 = bf3.readLine(); // reading name
                s7 = bf3.readLine(); // reading pass
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileReader file1 = new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Question.txt");
        BufferedReader bf = new BufferedReader(file1);
        FileReader file2 = new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Answer.txt");
        ...
        b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				if (Quiz.total >= 4) {//change 5 to 6 when add more questions its max number of questions
					return;
				}
                Quiz.total++;
				...
				try {
					...
					if (s == null) {
						// No more questions available, handle end of quiz
						// You can show the final score or perform any other actions here
						return;
					}
                    ...
                    if (s5 != null && !s5.isEmpty()) {
                        ...
                        // Handle the case where the answer is missing or empty
                        // You can choose to set a default value or display an error message
                        b.setVisible(false); ch = ' ';
                    }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (a == 1) {
                        ...
                        FileWriter file4 = new FileWriter("C:\\Users\\kunda\\Downloads\\JQUIZ\\Score.txt", true);
