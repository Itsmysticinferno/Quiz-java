...
{
	try{
	FileReader file3= new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Credentials.txt");// file object for answer file(change the file location where the file is saved)
...
{ 
	...
	FileReader file1= new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Question.txt");//file object for question file(change the file location where the file is saved)
	BufferedReader bf=new BufferedReader(file1);
	FileReader file2= new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Answer.txt");// file object for answer file(change the file location where the file is saved)
