...
public class MyResultWindow extends Frame
{
	public MyResultWindow()
	{
		...
		FileReader file1= new FileReader("C:\\Users\\kunda\\Downloads\\JQUIZ\\Score.txt");//file object for question file(change the file location where the file is saved)
